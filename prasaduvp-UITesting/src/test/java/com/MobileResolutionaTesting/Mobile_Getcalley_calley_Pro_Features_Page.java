...
public class Mobile_Getcalley_calley_Pro_Features_Page {
			...
			public static void main(String[] args) throws Exception {
				...
				String baseUrl ="https://www.getcalley.com/calley-pro-features/";
				...
				for (String resolution : resolutions) {
					for (WebDriver driver : drivers) {
						...
						String folderPath = "C:/Users/vara prasad/eclipse-workspace/web/MobileResolutionsScreenshots/Mobile_Getcalley_calley_Pro_Features_Page_Screenshots/Resolutions_screenshots/" + driver.getClass().getSimpleName() + "/" + resolution;
