...
public class Mobile_Getcalley_Page {
		...
		public static void main(String[] args) throws Exception {
			...
			for (String resolution : resolutions) {
				for (WebDriver driver : drivers) {
					...
					String folderPath = "C:/Users/vara prasad/eclipse-workspace/web/MobileResolutionsScreenshots/Mobile_Getcalley_Page_Screenshots/Resolutions_screenshots/" + driver.getClass().getSimpleName() + "/" + resolution;
