...
public class Mobile_Getcalley_Auto_DialerApp {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String resolution : resolutions) {
			for (WebDriver driver : drivers) {
				...
				String folderPath = "C:/Users/vara prasad/eclipse-workspace/web/MobileResolutionsScreenshots/Mobile_Getcalley_Auto_DialerApp_Screenshots/Resolutions_screenshots/" + driver.getClass().getSimpleName() + "/" + resolution;
