...
public class Mobile_Getcalley_how_calley_auto_Dialer_App_Works_Page {
		...
		public static void main(String[] args) throws Exception {
			...
			String baseUrl = "https://www.getcalley.com/best-auto-dialer-app/";
			...
			for (String resolution : resolutions) {
				for (WebDriver driver : drivers) {
					...
					String folderPath = "C:/Users/vara prasad/eclipse-workspace/web/MobileResolutionsScreenshots/Mobile_Getcalley_how_calley_auto_Dailer_App_Works_Page_Screenshots/Resolutions_screenshots/" + driver.getClass().getSimpleName() + "/" + resolution;
