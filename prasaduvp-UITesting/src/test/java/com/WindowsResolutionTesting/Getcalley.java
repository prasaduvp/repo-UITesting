...
public class Getcalley{
	...
	public static void main(String[] args) throws IOException, Exception {
		...
		for(Dimension resolution: resolutions) {
			...
			chromeDriver.get("https://www.getcalley.com/");
			Thread.sleep(3000);
			...
			try {
				...
				Thread.sleep(3000);
				String filepath = "C:/Users/vara prasad/eclipse-workspace/web/GetcalleyScreenshots/ChromeDriverScreenshots/Resolutions_Screenshot" + resolution.getWidth()+ "x" + resolution.getHeight() +date_time+ ".png";
		...
		for(Dimension resolution: resolutionss) {
			...
			firefoxDriver.get("https://www.getcalley.com/");
			Thread.sleep(3000);
			...
			try {
				...
				Thread.sleep(3000);
				String filepath = "C:/Users/vara prasad/eclipse-workspace/web/GetcalleyScreenshots/FirefoxDriverScreenshots/Resolutions_Screenshot" + resolution.getWidth()+ "x" + resolution.getHeight() +date_time+ ".png";
				FileUtils.copyFile(screenshotFile, new File(filepath));
			}catch(Exception e){
				e.printStackTrace();
			}
